...
import { adget_user } from "./Ad_UserSlice";
              ...
              <div className="card car-transparent">
                <div className="card-body p-0">
                  <div className="profile-image position-relative">
                    <img
                      src="admin/images/page-img/profile.png"
                ...
                <div className="card-body">
                  <div className="d-flex align-items-center mb-3">
                    <div className="profile-img position-relative">
                      <img
                        src="admin/images/user/1.jpg"
                        className="img-fluid rounded avatar-110"
                        alt="profile-image"
                      />
                    </div>
                    <div className="ml-3">
                      ...
                      <a href="#" className="btn btn-primary font-size-14">
                        Contact
                      </a>
                    </div>
                  </div>
                  <p>
                    I’m a Ux/UI designer. I spend my whole day, practically
                    every day, experimenting with new designs, making
                    illustartion, and animation.
                  </p>
                  ...
                  <div className="profile-content tab-content">
                    <div id="profile1" className="tab-pane fade active show">
                      <p>
                        ...
                        Turpis viverra viverra mollis sed vitae fames nunc
                        sollicitudin viverra. Curabitur massa, ultrices diam
                        ipsum faucibus risus. Hendrerit justo, quis massa a
                          ...
                          <ul className="list-inline p-0 m-0">
                            <li className="mb-4">
                              <div className="d-flex align-items-center pt-2">
                                <img
                                  src="admin/images/profile/service/01.png"
                                  className="img-fluid"
                                  alt="image"
                                />
                            ...
                            <li className="mb-4">
                              <div className="d-flex align-items-center pt-2">
                                <img
                                  src="admin/images/profile/service/02.png"
                            ...
                            <li>
                              <div className="d-flex align-items-center pt-2">
                                <img
                                  src="admin/images/profile/service/03.png"
                                  className="img-fluid"
                                  alt="image"
                                />
                                <div className="ml-3 w-100">
                        ...
                        <div className="col-lg-6">
                          <ul className="list-inline p-0 m-0">
                            <li className="mb-4">
                              <div className="d-flex align-items-center pt-2">
                                <img
                                  src="admin/images/profile/service/04.png"
                                  className="img-fluid"
                                  alt="image"
                                />
                                <div className="ml-3 w-100">
                            ...
                            <li className="mb-4">
                              <div className="d-flex align-items-center pt-2">
                                <img
                                  src="admin/images/profile/service/05.png"
                                  className="img-fluid"
                                  alt="image"
                                />
                                <div className="ml-3 w-100">
                            ...
                            <li>
                              <div className="d-flex align-items-center pt-2">
                                <img
                                  src="admin/images/profile/service/06.png"
                                  className="img-fluid"
                                  alt="image"
                                />
                                <div className="ml-3 w-100">
                            ...
                            <div className="card-body p-3">
                              <div className="row align-items-center text-center py-2">
                                <div className="profile-info col-xl-3 col-sm-6 mb-3 mb-lg-0">
                                  ...
                                  <h5 className="mb-2 mt-3 icon-text-warning">
                                    15+
                                  </h5>
                                ...
                                <div className="profile-info col-xl-3 col-sm-6 mb-3 mb-lg-0">
                                  ...
                                  <h5 className="mb-2 mt-3 icon-text-info">
                                    35+
                                  </h5>
                                ...
                                <div className="profile-info col-xl-3 col-sm-6 mb-3 mb-sm-0">
                                  ...
                                  <h5 className="mb-2 mt-3 icon-text-danger">
                                    04+
                                  </h5>
                                ...
                                <div className="profile-info col-xl-3 col-sm-6">
                                  ...
                                  <h5 className="mb-2 mt-3 icon-text-success">
                                    90+
                                  </h5>
                                  ...
                                  <ul className="list-inline p-0 mb-0">
                                    <li>
                                      <div className="d-flex align-items-center justify-content-between mb-2">
                                        <p className="mb-0 font-size-16 mr-3">
                                          English
                                        </p>
                                        <h6>78%</h6>
                                      </div>
                                ...
                                <div className="card-body p-3">
                                  <ul className="list-inline p-0 m-0">
                                    <li className="mb-2 d-flex">
                                      <span>
                                        <i className="lab la-facebook-f icon-text-primary font-size-20 mr-3" />
                                      </span>
                                    ...
                                    <li className="mb-2 d-flex">
                                      <span>
                                        <i className="lab la-twitter icon-text-info font-size-20 mr-3" />
                                      </span>
                                      <p className="mb-0 line-height">
                                        @nataliedawson
                                      </p>
                                    ...
                                    <li className="d-flex">
                                      <span>
                                        <i className="lab la-instagram icon-text-danger font-size-20 mr-3" />
                                      </span>
                                      <p className="mb-0 line-height">
                                        @natalietweets
                                      </p>
                            ...
                            <div className="row align-items-top">
                              ...
                              <div className="col-md-9">
                                <div className="media profile-media align-items-top">
                                  ...
                                  <div className="ml-4">
                                    <h6 className="mb-1">
                                      Software Engineer at Mathica Labs
                                    </h6>
                                    <p className="mb-0 font-size-14">
                                      Total : 02 + years of experience
                                    </p>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div className="row align-items-top">
                              ...
                              <div className="col-md-9">
                                <div className="media profile-media align-items-top">
                                  ...
                                  <div className="ml-4">
                                    <h6 className="mb-1">
                                      Junior Software Engineer at Zimcore
                                      Solutions
                                    </h6>
                                    <p className="mb-0 font-size-14">
                                      Total : 1.5 + years of experience
                                    </p>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div className="row align-items-top">
                              ...
                              <div className="col-md-9">
                                <div className="media profile-media align-items-top">
                                  ...
                                  <div className="ml-4">
                                    <h6 className="mb-1">
                                      Junior Software Engineer at Skycare Ptv.
                                      Ltd
                                    </h6>
                                    <p className="mb-0 font-size-14">
                                      Total : 0.5 + years of experience
                                    </p>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div className="row align-items-top">
                              ...
                              <div className="col-9">
                                <div className="media profile-media pb-0 align-items-top">
                                  ...
                                  <div className="ml-4">
                                    <h6 className="mb-1">
                                      Junior Software Engineer at Infosys
                                      Solutions
                                    </h6>
                                    <p className="mb-0 font-size-14">
                                      Total : Freshers
                    ...
                    <div id="profile5" className="tab-pane fade">
                      <p>
                        ...
                        websites worldwide. Mauris variustellus vitae tristique
                        sagittis. Sed aliquet, est nec auctor aliquet, orci ex
                        vestibulum ex, non pharetra lacus erat ac nulla.
                      </p>
                      <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Iaculis mattis nam ipsum pharetra porttitor eu orci,
                        nisi. Magnis elementum vitae eu, dui et. Tempus etiam
                        feugiat sem augue sed sed. Tristique feugiat mi feugiat
                        integer consectetur sit enim penatibus. Quis sagittis
                        proin fermentum tempus uspendisse ultricies. Tellus
                        sapien, convallis proin pretium.
                      </p>
                      <p className="mb-0">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Iaculis mattis nam ipsum pharetra porttitor eu.
                        Tristique feugiat mi feugiat integer consectetur sit
                        enim penatibus. Quis sagittis proin fermentum tempus
                        uspendisse ultricies. Tellus sapien, convallis proin
                        pretium.
                      </p>
                    </div>
                  </div>
